...
with tab5:
    ...
    Gender = st.radio('Pilih Gender',['0','1'])
    On_thyroxine = st.radio('On thyroxine',['0','1'])
    Query_on_thyroxine = st.radio('Query on thyroxine',['0','1'])
    On_antithyroid_medication = st.radio('On antithyroid medication',['0','1'])
    sick = st.radio('Sick',['0','1'])
    pregnant = st.radio('Pregnant',['0','1'])
    Thyroid_surgery = st.radio('Thyroid surgery',['0','1'])
    I131_treatment = st.radio('I131 treatment',['0','1'])
    Query_hypothyroid = st.radio('Query hypothyroid',['0','1'])
    Query_hyperthyroid = st.radio('Query hyperthyroid',['0','1'])
    Lithium = st.radio('Lithium',['0','1'])
    Goitre = st.radio('Goitre',['0','1'])
    Tumor = st.radio('Tumor',['0','1'])
    Hypopituitary = st.radio('Hypopituitary',['0','1'])
    Psych = st.radio('Psych',['0','1'])
    TSH_Measured = st.radio('TSH measured',['0','1'])
    TSH = st.number_input('TSH : ', -1,1000)
    T3_Measured = st.radio('T3 measured',['0','1'])    
    T3 = st.number_input('T3 : ', -1,1000)
    TT4_Measured = st.radio('TT4 measured',['0','1'])
    TT4 = st.number_input('TT4 : ', -1,1000)
    T4U_Measured = st.radio('T4U measured',['0','1'])
    T4U = st.number_input('T4U : ', -1,1000)
    FTI_Measured = st.radio('FTI measured',['0','1'])
    FTI = st.number_input('FTI : ', -1,1000)
    TBG_Measured = st.radio('TBG measured',['0','1'])
    TBG = st.text_input('TBG')
    Referral_source = st.multiselect('Referral source',['0', '1', '2', '3', '4'])
